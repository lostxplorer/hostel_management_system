...
<div class="form-group container">
    <form action="add_rec1.php" method="post">
        ...
        <div class="row">
            ...
            <input type="radio" class = "form-check-input" name = "gender"  value="male">Male</input><br>
            <input type="radio" class = "form-check-input" name = "gender"  value="female">Female</input>
            </div>
            <div class="col-md-2">
            <label for="prev">Previlage </label><br>
            <input type="radio" class = "form-check-input" name = "prev"  value="0">Student</input><br>
            <input type="radio" class = "form-check-input" name = "prev"  value="1">Warden</input>
            </div>
        </div>
        <br>
        <br>
